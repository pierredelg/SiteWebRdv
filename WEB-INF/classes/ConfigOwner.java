...
public class ConfigOwner extends HttpServlet
{
    ...
    //Récupération des données du formulaire 
       ...
       emailEntreprise.replace('<',' ');
       emailEntreprise.replace('>',' ');
       telephoneEntreprise.replace('\'',' ');
       telephoneEntreprise.replace('"',' ');
       telephoneEntreprise.replace('<',' ');
       telephoneEntreprise.replace('>',' ');
       textBienvenue.replace('\'',' ');
       textBienvenue.replace('"',' ');
       textBienvenue.replace('<',' ');
       textBienvenue.replace('>',' ');
       urlImage.replace('\'',' ');
       ...
       urlImage.replace('<',' ');
       urlImage.replace('>',' ');
       horaireLundi.replace('\'',' ');
       horaireLundi.replace('"',' ');
       horaireLundi.replace('<',' ');
       horaireLundi.replace('>',' ');
       horaireMardi.replace('\'',' ');
       horaireMardi.replace('"',' ');
       horaireMardi.replace('<',' ');
       horaireMardi.replace('>',' ');
       horaireMercredi.replace('\'',' ');
       horaireMercredi.replace('"',' ');
       horaireMercredi.replace('<',' ');
       horaireMercredi.replace('>',' ');
       horaireJeudi.replace('\'',' ');
       horaireJeudi.replace('"',' ');
       horaireJeudi.replace('<',' ');
       horaireJeudi.replace('>',' ');
       horaireVendredi.replace('\'',' ');
       horaireVendredi.replace('"',' ');
       horaireVendredi.replace('<',' ');
       horaireVendredi.replace('>',' ');
       horaireSamedi.replace('\'',' ');
       horaireSamedi.replace('"',' ');
       horaireSamedi.replace('<',' ');
       horaireSamedi.replace('>',' ');
       horaireDimanche.replace('\'',' ');
       horaireDimanche.replace('"',' ');
       horaireDimanche.replace('<',' ');
       horaireDimanche.replace('>',' ');
